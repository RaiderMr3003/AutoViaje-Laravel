            ...
            <div class="flex justify-between h-16">
                ...
                <div class="flex items-center">
                    ...
                    <form method="POST" action="{{ route('logout') }}">
                        @csrf
                        <button type="submit"
                            class="text-sm font-medium text-[#f53003] hover:text-[#d92a02] hover:underline dark:text-[#FF4433] dark:hover:text-[#ff6b5c] transition-colors focus:outline-none cursor-pointer">
                            Cerrar Sesión
                        </button>
                    </form>
                </div>
